...
- [ ] Task: Define standardized models for `Market`, `OrderBook`, `Trade`, and `Position` in `models.py`
    - [ ] Task: Write tests for model validation and serialization
    - [ ] Task: Implement models using Pydantic
